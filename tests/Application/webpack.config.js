...
const [bitbagOrderCreationShop, bitbagOrderCreationAdmin] = require('../../webpack.config.js');
...
module.exports = [shopConfig, adminConfig, bitbagOrderCreationShop, bitbagOrderCreationAdmin];
